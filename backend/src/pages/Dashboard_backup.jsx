...
// Unit grouping
const TRACKS = [
  { id: 'qms', titleKey: 'track_qms', units: ['gmp-intro', 'ich-q10', 'adv-gmp'], icon: 'ًںڈ†', color: '#17a2b8' },
  { id: 'sterile', titleKey: 'track_sterile', units: ['sterile-annex1'], icon: 'ًں›،ï¸ڈ', color: '#6c757d' },
  { id: 'data_integrity', titleKey: 'track_data_integrity', units: ['data-integrity', 'gamp5-basics', 'batch-records'], icon: 'ًں’»', color: '#6610f2' },
  { id: 'qrm', titleKey: 'track_qrm', units: ['qrm-basics', 'adv-qrm'], icon: 'âڑ ï¸ڈ', color: '#e83e8c' },
  { id: 'validation', titleKey: 'track_validation', units: ['validation-qualification', 'adv-validation'], icon: 'âœ…', color: '#20c997' },
  { id: 'gdp', titleKey: 'track_gdp', units: ['gdp-basics', 'adv-gdp'], icon: 'ًںڑڑ', color: '#fd7e14' },
  { id: 'regulatory', titleKey: 'track_regulatory', units: ['nmpb-reg', 'ich-guidelines', 'glp-basics', 'iso-17025', 'adv-glp', 'adv-iso-17025'], icon: 'âڑ–ï¸ڈ', color: '#009688' },
];

// Unit icons mapping - visual icons for each unit
const UNIT_ICONS = {
  'gmp-intro': { icon: 'ًںڈ­', color: '#28a745', title: { ar: 'ظ…ظ‚ط¯ظ…ط© ظپظٹ GMP', en: 'Intro to GMP' } },
  'glp-basics': { icon: 'ًں”¬', color: '#007bff', title: { ar: 'ظ…ط¨ط§ط¯ط¦ GLP', en: 'GLP Basics' } },
  'iso-17025': { icon: 'ًں“ٹ', color: '#ffc107', title: { ar: 'ISO 17025', en: 'ISO 17025' } },
  'ich-guidelines': { icon: 'ًںŒگ', color: '#dc3545', title: { ar: 'ط¥ط±ط´ط§ط¯ط§طھ ICH', en: 'ICH Guidelines' } },
  'validation-qualification': { icon: 'âœ…', color: '#20c997', title: { ar: 'ط§ظ„طھط­ظ‚ظ‚ ظˆط§ظ„طھط£ظ‡ظٹظ„', en: 'Validation & Qualification' } },
  'data-integrity': { icon: 'ًں”’', color: '#6610f2', title: { ar: 'ط³ظ„ط§ظ…ط© ط§ظ„ط¨ظٹط§ظ†ط§طھ', en: 'Data Integrity' } },
  'qrm-basics': { icon: 'âڑ ï¸ڈ', color: '#e83e8c', title: { ar: 'ط¥ط¯ط§ط±ط© ط§ظ„ظ…ط®ط§ط·ط±', en: 'QRM Basics' } },
  'gdp-basics': { icon: 'ًںڑڑ', color: '#fd7e14', title: { ar: 'ظ…ظ…ط§ط±ط³ط§طھ ط§ظ„طھظˆط²ظٹط¹', en: 'GDP Basics' } },
  'ich-q10': { icon: 'ًںڈ†', color: '#17a2b8', title: { ar: 'ظ†ط¸ط§ظ… Q10', en: 'ICH Q10' } },
  'sterile-annex1': { icon: 'ًں›،ï¸ڈ', color: '#6c757d', title: { ar: 'ط§ظ„طھطµظ†ظٹط¹ ط§ظ„ظ…ط¹ظ‚ظ…', en: 'Sterile Mfg' } },
  'gamp5-basics': { icon: 'ًں’»', color: '#343a40', title: { ar: 'GAMP 5', en: 'GAMP 5' } },
  'batch-records': { icon: 'ًں“‌', color: '#6610f2', title: { ar: 'ط³ط¬ظ„ط§طھ ط§ظ„طھط´ط؛ظٹظ„', en: 'Batch Records' } },
  'nmpb-reg': { icon: 'ًں‡¸ًں‡©', color: '#009688', title: { ar: 'ط§ظ„ط±ظ‚ط§ط¨ط© ط§ظ„ط¯ظˆط§ط¦ظٹط©', en: 'NMPB Regulatory' } },
  'adv-gmp': { icon: 'ًںڈ­+', color: '#28a745', title: { ar: 'ظ…ظ…ط§ط±ط³ط§طھ ط§ظ„طھطµظ†ظٹط¹ ط§ظ„ظ…طھظ‚ط¯ظ…ط©', en: 'Adv. GMP' } },
  'adv-glp': { icon: 'ًں”¬+', color: '#007bff', title: { ar: 'طھط­ظ„ظٹظ„ ط¨ظٹط§ظ†ط§طھ GLP', en: 'Adv. GLP' } },
  'adv-iso-17025': { icon: 'ًں“ٹ+', color: '#ffc107', title: { ar: 'ط§ظ„طھط·ط¨ظٹظ‚ ط§ظ„ط¹ظ…ظ„ظٹ ظ„ظ€ ISO', en: 'Adv. ISO' } },
  'adv-validation': { icon: 'âœ…+', color: '#20c997', title: { ar: 'ط§ظ„طھط­ظ‚ظ‚ ط§ظ„ظ…طھظ‚ط¯ظ…', en: 'Adv. Validation' } },
  'adv-qrm': { icon: 'âڑ ï¸ڈ+', color: '#e83e8c', title: { ar: 'طھط·ط¨ظٹظ‚ط§طھ QRM', en: 'Adv. QRM' } },
  'adv-gdp': { icon: 'ًںڑڑ+', color: '#fd7e14', title: { ar: 'ط³ظ„ط³ظ„ط© ط§ظ„طھط¨ط±ظٹط¯', en: 'Adv. GDP' } },
};
  ...
  const DeveloperProfileModal = () => (
    <div style={{
      ...
      <div style={{
        ...
        <button onClick={() => setShowDevProfile(false)} style={{ position: 'absolute', top: '20px', right: language === 'ar' ? 'auto' : '20px', left: language === 'ar' ? '20px' : 'auto', border: 'none', background: 'none', fontSize: '1.5rem', cursor: 'pointer' }}>âœ•</button>
<div style={{ width: '150px', height: '150px', borderRadius: '50%', margin: '0 auto 20px', border: '5px solid #28a745', overflow: 'hidden' }}>
        ...
        <div style={{ backgroundColor: '#f9f9f9', padding: '20px', borderRadius: '20px', textAlign: language === 'ar' ? 'right' : 'left', marginBottom: '30px', fontSize: '1rem' }}>
          <p style={{ lineHeight: '1.8', margin: '5px 0' }}>â€¢ {t('developerTitle')}</p>
          <p style={{ lineHeight: '1.8', margin: '5px 0' }}>â€¢ {language === 'ar' ? 'ظ…طھط®طµطµ ط§ظ„طھط¯ط±ظٹط¨ ظˆط§ظ„طھط£ظ‡ظٹظ„ ط§ظ„ط¯ظˆط§ط¦ظٹ' : 'Pharmaceutical Training & Qualification Specialist'}</p>
          <p style={{ lineHeight: '1.8', margin: '5px 0' }}>â€¢ {language === 'ar' ? `ظ…ط¤ط³ط³ ${t('issuingAuthority')}` : `Founder of ${t('issuingAuthority')}`}</p>
        </div>
  ...
  const MicroBadge = ({ unitId, score }) => {
    ...
    return (
      <div style={{
        ...
        <span style={{ fontSize: '1.5rem' }}>{isUnlocked ? 'ًں¥‡' : 'ًں”’'}</span>
        ...
        <div id="certificate-printable" style={{
          ...
          <div className="no-print" style={{ position: 'absolute', bottom: '20px', left: '50%', transform: 'translateX(-50%)', zIndex: 10, display: 'flex', gap: '15px' }}>
            <button onClick={downloadCertificatePDF} style={{ padding: '12px 40px', fontSize: '1.1rem', backgroundColor: 'var(--pharma-navy)', color: 'white', border: 'gold 1px solid', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', boxShadow: '0 4px 15px rgba(0,0,0,0.3)' }}>
              ًں“„ {language === 'ar' ? 'طھط­ظ…ظٹظ„ PDF (ط±ط³ظ…ظٹ)' : 'Download PDF (Official)'}
            </button>
  ...
  return (
    <div style={{
      ...
      <header className="main-header glass-panel" style={{ borderRadius: '0 0 24px 24px', margin: '0 20px', backgroundColor: 'var(--primary-color)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <button onClick={toggleLanguage} className="btn-lang">
            {language === 'ar' ? 'English' : 'ط§ظ„ط¹ط±ط¨ظٹط©'}
          </button>
          ...
          <div className="user-profile">
            ...
            <span title="Cloud Sync Active" style={{ fontSize: '0.8rem', marginLeft: '8px', opacity: 0.8 }}>âکپï¸ڈ</span>
          </div>
        ...
        {viewMode === 'academy' ? (
          <div className="animate-fade-in">
            ...
            <section className="glass-panel" style={{ padding: '30px', borderRadius: '24px', marginBottom: '30px' }}>
              <h3 style={{ marginBottom: '20px', color: 'var(--primary-color)', display: 'flex', alignItems: 'center', gap: '10px' }}>
                <span style={{ fontSize: '1.5rem' }}>ًںژ«</span> {t('microBadge')} Wallet
              </h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 350px', gap: '30px', alignItems: 'start' }}>
                ...
                {!currentTrack ? (
                  <>
                    <h3 style={{ marginBottom: '25px', color: 'var(--primary-color)', display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <span style={{ fontSize: '1.5rem' }}>ًںژ“</span> {t('academy')} - {language === 'ar' ? 'ط§ظ„ظ…ط³ط§ط±ط§طھ ط§ظ„ط§ط­طھط±ط§ظپظٹط©' : 'Professional Tracks'}
                    </h3>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div style={{ backgroundColor: track.color, color: 'white', padding: '8px 20px', borderRadius: '20px', fontSize: '0.85rem', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '5px' }}>
                              ًں“ڑ {track.units.length} {language === 'ar' ? 'ظˆط­ط¯ط§طھ' : 'Units'}
                            </div>
                          </div>
                        );
                      })}
                  ...
                  <>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '25px' }}>
                      ...
                      >
                        {language === 'ar' ? 'â†گ ط§ظ„ط¹ظˆط¯ط© ظ„ظ„ظ…ط³ط§ط±ط§طھ' : 'â†گ Back to Tracks'}
                      </button>
                    </div>
                    
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
                      {units.map((unit) => {
                        const unitIcon = UNIT_ICONS[unit.id] || { icon: 'ًں“–', color: '#28a745' };
                          ...
                          >
                            ...
                            {finishedLecture && (
                              <div style={{ backgroundColor: '#d4edda', color: '#155724', padding: '6px 15px', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 'bold', display: 'inline-block' }}>
                                âœ“ {language === 'ar' ? 'ظ…ظƒطھظ…ظ„' : 'Completed'}
                              </div>
                            )}
              ...
              <div className="certificate-sidebar">
                <div className="cert-trophy">ًںڈ†</div>
          ...
          <div className="animate-fade-in">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '30px' }}>
              <section className="glass-panel" style={{ padding: '30px', borderRadius: '24px' }}>
                <h3 style={{ marginBottom: '25px', color: 'var(--primary-color)', display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <span style={{ fontSize: '1.5rem' }}>ًں“ٹ</span> {language === 'ar' ? 'طھط­ظ„ظٹظ„ طھظ‚ط¯ظ…ظƒ' : 'Your Progress Analytics'}
                </h3>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '20px', marginBottom: '30px' }}>
                  <div style={{ backgroundColor: 'var(--bg-card)', padding: '25px', borderRadius: '20px', textAlign: 'center', border: '2px solid var(--primary-color)' }}>
                    ...
                    <div style={{ color: 'var(--text-secondary)', marginTop: '8px', fontWeight: '500' }}>{language === 'ar' ? 'ظˆط­ط¯ط© ظ…ظƒطھظ…ظ„ط©' : 'Units Completed'}</div>
                  </div>
                  <div style={{ backgroundColor: 'var(--bg-card)', padding: '25px', borderRadius: '20px', textAlign: 'center', border: '2px solid #ffc107' }}>
                    ...
                    <div style={{ color: 'var(--text-secondary)', marginTop: '8px', fontWeight: '500' }}>{language === 'ar' ? 'ظ…طھظˆط³ط· ط§ظ„ط¯ط±ط¬ط§طھ' : 'Average Score'}</div>
                  </div>
                  <div style={{ backgroundColor: 'var(--bg-card)', padding: '25px', borderRadius: '20px', textAlign: 'center', border: `2px solid ${allPassed ? '#28a745' : '#6c757d'}` }}>
                    <div style={{ fontSize: '2.5rem' }}>{allPassed ? 'ًںڈ†' : 'ًں”’'}</div>
                    <div style={{ color: 'var(--text-secondary)', marginTop: '8px', fontWeight: '500' }}>{language === 'ar' ? 'ط­ط§ظ„ط© ط§ظ„ط´ظ‡ط§ط¯ط©' : 'Certificate Status'}</div>
                    <div style={{ fontSize: '0.85rem', fontWeight: 'bold', color: allPassed ? '#28a745' : '#6c757d', marginTop: '4px' }}>{allPassed ? (language === 'ar' ? 'ظ…ظƒطھظ…ظ„ط© âœ“' : 'Earned âœ“') : (language === 'ar' ? 'ظ‚ظٹط¯ ط§ظ„طھظ‚ط¯ظ…' : 'In Progress')}</div>
                  </div>
                </div>
                <h4 style={{ color: 'var(--text-primary)', marginBottom: '20px' }}>{language === 'ar' ? 'ًں“‹ طھظپط§طµظٹظ„ ط§ظ„ط¯ط±ط¬ط§طھ ظ„ظƒظ„ ظˆط­ط¯ط©' : 'ًں“‹ Score Details by Unit'}</h4>
                    ...
                    return (
                      <div key={unit.id}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px', alignItems: 'center' }}>
                          ...
                          <span style={{ fontWeight: 'bold', color: isPassed ? '#28a745' : score > 0 ? '#ffc107' : 'var(--text-secondary)', minWidth: '75px', textAlign: 'right' }}>{score > 0 ? `${score}%` : (language === 'ar' ? 'ظ„ظ… ظٹط¨ط¯ط£' : 'Not Started')}</span>
                        </div>
              ...
              <section className="glass-panel" style={{ padding: '25px', borderRadius: '24px' }}>
                  ...
                  {leaderboard.length > 0 ? (
                    leaderboard.sort((a, b) => b.xp - a.xp).map((entry, idx) => (
                      <div key={idx} style={{ 
                        ...
                        <div style={{ fontSize: '1.2rem' }}>{entry.photoURL ? <img src={entry.photoURL} style={{ width: '24px', height: '24px', borderRadius: '50%' }} /> : (entry.isUser || entry.userId === user.uid ? 'â­گ' : 'ًں‘¤')}</div>
                        <div style={{ flex: 1 }}>
                          <div style={{ fontWeight: 'bold', fontSize: '0.9rem' }}>{entry.displayName || (entry.userId === user.uid ? t('you') : 'Trainee')}</div>
                          <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>Lvl {entry.level || 1} â€¢ {entry.xp || 0} XP</div>
                        </div>
                      </div>
                    ))
                  ) : (
                    <div style={{ textAlign: 'center', padding: '20px', color: 'var(--text-secondary)' }}>
                      {language === 'ar' ? 'ط¬ط§ط±ظٹ طھط­ظ…ظٹظ„ ط§ظ„ظ…طھطµط¯ط±ظٹظ†...' : 'Loading Leaderboard...'}
                    </div>
                  )}
                </div>
                <div style={{ marginTop: '20px', padding: '15px', backgroundColor: 'var(--bg-body)', borderRadius: '12px', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                  ًں’، {language === 'ar' ? 'ظ†طھط§ط¦ط¬ ط¨ظ‚ظٹط© ط§ظ„ظ…طھط¯ط±ط¨ظٹظ† طھط¸ظ‡ط± ظ‡ظ†ط§ ط¨ظ†ط§ط،ظ‹ ط¹ظ„ظ‰ ط£ط¯ط§ط¦ظ‡ظ… ط§ظ„ظپط¹ظ„ظٹ.' : 'Live trainee rankings based on actual platform performance.'}
                </div>
              </section>
            </div>
          </div>
      ...
      <footer style={{ textAlign: 'center', padding: '40px', color: '#888', borderTop: '1px solid #eee' }}>
        ...
        <p style={{ fontSize: '0.8rem' }}>آ© {new Date().getFullYear()} Sudan Quality Platform. All International Patents Reserved.</p>
      </footer>
