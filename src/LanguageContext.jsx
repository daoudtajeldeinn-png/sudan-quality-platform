...
export const translations = {
    ar: {
        ...
        cleaningValidation: 'التحقق من التنظيف (Cleaning Validation)',
        track_specialized: 'الدورات التخصصية والاحترافية',
        unit_spec: 'وحدة تخصصية',
        track_advanced_validation: 'مسارات التحقق والتوثيق المتقدمة',
        track_quality_systems: 'أنظمة الجودة المتكاملة',
        processValidation: 'التحقق من العمليات (Process Validation)',
        holdTimeStability: 'ثبات فترة الاستبقاء (Hold Time Stability)',
        methodValidation: 'التحقق من طرق التحليل (Method Validation)',
        equipmentQualification: 'تأهيل الأجهزة والمرافق (Equipment Qualification)',
        analytics: 'التحليلات',
    ...
    en: {
        ...
        track_specialized: 'Specialized & Professional Courses',
        unit_spec: 'Specialized Unit',
        track_advanced_validation: 'Advanced Validation & Qualification',
        track_quality_systems: 'Integrated Quality Systems',
        processValidation: 'Process Validation',
        holdTimeStability: 'Hold Time Stability',
        methodValidation: 'Analytical Method Validation',
