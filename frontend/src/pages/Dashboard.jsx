                  ...
                  {leaderboard.length > 0 ? (
                    leaderboard.sort((a, b) => b.xp - a.xp).map((entry, idx) => (
                      <div key={idx} style={{ 
                        ...
                        <div style={{ fontSize: '1.2rem' }}>{entry.photoURL ? <img src={entry.photoURL} style={{ width: '24px', height: '24px', borderRadius: '50%' }} alt="" /> : (entry.isUser || entry.userId === user.uid ? '⭐' : '👤')}</div>
                        <div style={{ flex: 1 }}>
